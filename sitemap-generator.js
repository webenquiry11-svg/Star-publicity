...
// All of your public-facing URLs from App.jsx
const links = [
  // --- Core Pages ---
  ...
  // --- IMPORTANT: Add your specific blog post URLs here manually ---
  // Example:
  // { url: '/resources/blogs/benefits-of-ooh-advertising', changefreq: 'yearly', priority: 0.6 },
  // { url: '/resources/blogs/top-5-creative-bus-ads', changefreq: 'yearly', priority: 0.6 },

];

// Your website's base URL
const hostname = 'https://www.starpublicity.co.in';
