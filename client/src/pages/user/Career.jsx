...
const Career = () => {
  // 2. Define the schema for the Career page
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "url": "https://www.starpublicity.co.in/career",
    "name": "Careers at Star Publicity | Join Our Team",
    "description": "Explore career opportunities at Star Publicity, North India's leading outdoor advertising agency. Join a creative and innovative team that values passion and growth.",
    "publisher": {
      "@type": "Organization",
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Careers at Star Publicity | Join Our Team</title>
        <meta 
          name="description" 
          content="Explore career opportunities at Star Publicity, North India's leading outdoor advertising agency. Join a creative and innovative team that values passion and growth." 
        />
        <link rel="canonical" href="https://www.yourwebsite.com/career" />
