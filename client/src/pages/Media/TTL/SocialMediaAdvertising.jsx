  ...
  const processSteps = [
    {
      ...
      description:
        "Understanding just what your audience is and what they like to see and share, you can easily leverage sentiment analysis and competitor scans.",
    ...
    {
      title: "Creative Spark Lab",
      description:
        "Then produce thumb-stopping content such as videos, graphics, and influencer scripts, optimized for each platform.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: " Precision Launchpad",
      description:
        "Now, time to deploy campaigns with smart budget splits, geo-targeting, and real-time schedule adjustments on Facebook, Instagram, and more.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: " Engagement Pulse Tracking",
      description:
        "Then we monitor in-platform analytics for every social media handle and audience feedback to maximize reach and conversions.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/TTL marketing images/Social media ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            In India, social media turns every scroll, swipe, and share into an opportunity for a genuine connection or customer.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Brand Comes Online
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
          From loud launches to subtle promotions, social media ads boast conversations, loyalty, and viral momentum to create a chain of customers.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Social media ads/hyper.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                In today’s high-tech world, delve into AI and algorithm-driven targeting, such as targeting audiences by age, interest, behavior, and even intent.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Social media ads/short form.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               One of the trending and most promoted formats today is social media reels, shorts, and stories as they thrive on emotion, storytelling, and engagement. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Social media ads/data.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Constant testing, retargeting, social listening, and deep analytics ensure every rupee spent on social media ads are optimized for true ROI.
              </p>
            </div>
          </div>
        </div>
...
Path to Digital Journey          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            Let’s find out the steps to start your social media campaign, mapped from brainstorming to final sale.
          </p>
        </div>
