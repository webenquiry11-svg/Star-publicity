...
const MallInsideLedAds = () => {
  ...
  const processSteps = [
    {
      title: "Premium Location Mapping ",
      description:
        "Identify high-footfall malls with the right geographical location and traffic, and select prime LED screen spots from entrances.",
    ...
    {
      title: "Compelling Content Crafting ",
      description:
        "Our production team crafts striking visuals, animations, and interactive messages customized for high-resolution and peak-brightness display environments. ",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Then we prepare a strategy to place your ads for weekend surges, festival seasons, or special mall events to uplift footfall rates.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Tracking of your campaign is very important, as this step informs us regarding the impression data and audience interaction in order to define ROI.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/TTL marketing images/Mall inside led/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Time to represent your brand on India’s most prestigious shopping squares with Mall Inside LED Ads
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          Convert every mall visit into a chance for your brand to spark recognition, reach, and trust for more conversions and sales
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Mall inside led/high visibility.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               The major advantage of this media format is that LED screens are strategically located inside malls or even at entrances, reaching every visitor and shopper.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Mall inside led/high spending.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Mostly visitors spend extended time inside malls which makes your ads virtually unskippable and boosting brand recall.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Mall inside led/dynamic.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Every time, LED ads can be programmed for playing multiple ads, real-time offers, and event tie-ins to stay relevant and attention-grabbing.
              </p>
            </div>
          </div>
        </div>
...
Journey to LED Ads          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            Under your brilliantly explained campaign inside malls in four flexible steps.
          </p>
        </div>
...
export default MallInsideLedAds;