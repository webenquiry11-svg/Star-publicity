  ...
  const processSteps = [
    {
      ...
      description:
        "Firstly, fuel targeting and relevant messaging to gather and verify segment audiences by interest, transaction, region, or lifestyle.",
    ...
    {
      title: "Content & Creative Lab",
      description:
        "Then, we develop irresistible taglines, smart message flows, visually appealing graphics, and WhatsApp/email templates tailored to each campaign and audience.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: " Automated Rollout & Replies ",
      description:
        "Use sequenced email journeys, WhatsApp broadcasts, and interactive flows that provides instant replies and conversions.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Analytics & Iteration Hub",
      description:
        "We also provide you with analytical insights by measuring conversions, opt-outs, and sentiment for always-improving outcomes.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/TTL marketing images/Email Whatsapp/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Break through the noise with two of India’s most trusted and regularly used inboxes. Let’s uplift your brand with Email and WhatsApp marketing.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Personalised Messages Return ROI
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Time to grab the power of email and WhatsApp marketing, where every campaign is a customised connection.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Email Whatsapp/hyper.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               This digital strategy provides insights that enable personalized targeting, delivering recommendations, reminders, and offers required for each user.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Email Whatsapp/conversational.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                 Conversational, Real-Time Reach
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Platforms like WhatsApp and email let you send updates, contests, event invites, and customer feedback requests instantly.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Email Whatsapp/rich media.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
              You can flawlessly send engaging GIFs, polls, videos, and interactive carousels for sparking reactions while connecting and delighting.
              </p>
            </div>
          </div>
        </div>
...
Pathway to One-to-One Impact          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
           Let’s understand through simple steps how your campaign is engineered for real conversations and real ROI.
          </p>
        </div>
