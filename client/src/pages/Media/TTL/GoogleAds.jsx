...
const GoogleAds = () => {
  ...
  const processSteps = [
    {
      title: "Keyword Universe Mapping",
      description:
        "Firstly, we find out high-intent, relevant keywords for your campaign that blend manual research with machine insights and trending queries.",
    ...
    },
    {
      ...
      description:
        "Then we create compelling, audience-focused ads that can influence your target audience in the first 2-3 seconds.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Smart Launch & Optimization",
      description:
        "Launch audience-focused fine-tuned ads, and then activate automation for ongoing tweaks and improved performance week-by-week.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Star Publicity track impressions, clicks, cost, conversions, and various other parameters to deliver insights for compounding returns.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/TTL marketing images/Google Ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
        Time to turn every query, comparison, and curiosity across India into a growth opportunity with Google Ads.
          </p>
          {/* <button
      ...
      >
        ...
        Where Searches Meets ROI
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
    Let’s take the next big move with ads that turn every click into an opportunity for your ad, their need, and our conversion.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Google Ads/responsive.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Provides you various options to tailor your presence using search, display, shopping, video, discovery, and Performance Max ads for maximum visibility.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Google Ads/negative.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
             Also, you should be budget focused in order to easily filter out irrelevant or fake clicks and boost your conversion rate.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Google Ads/data first.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Easily monitor performance with granular analytics, visuals, and landing pages to boost conversion rates and maximize ROI.
              </p>
            </div>
          </div>
        </div>
...
Click-to-Conversion Steps          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
From ideas to monitoring the final dashboard, let’s go through the four simple steps that make your campaign thrive.
          </p>
        </div>
