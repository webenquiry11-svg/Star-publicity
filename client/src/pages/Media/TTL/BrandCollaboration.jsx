  ...
  const processSteps = [
    {
      ...
      description:
        "Firstly, we spend our time analyzing your goals and audience gaps in order to identify partners with complementary strengths and values.",
    ...
    {
      title: "Joint Vision Design",
      description:
        "Then we start developing a plan which defines roles, campaign themes, and creative formats to ensure that both voices and brands shine.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Collaborative Rollout ",
      description:
        "Next, we co-create content, events, offers, and prepare strategy for social, in-store, digital, and influencer networks.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Finally, we focus on tracking reach, engagement, and sales, only fruitful for your brand,  and also plan further ongoing collaborations.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/TTL marketing images/Brand Collaboration/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
          Brand Collaboration is the most-loved shortcut to credibility, reach, and innovation, building buzz nationwide.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Brands Meet and Magic Happens
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            At present, collaborations are spreading brands worldwide and are transforming products, experiences, and stories every day.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Brand Collaboration/audience.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Audience Exchange Boost 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Reach your geographically targeted customers by instantly stepping into your collaborator’s circle.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Brand Collaboration/shared costs.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Shared Costs, Doubled Resources 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Major benefit is that you can split production, platform, and media costs for maximum impact, also ideal for startups and MNCs.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/Brand Collaboration/trust.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Trust and Image Leap
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
              The important thign is that, collaboration build trust which in turn maximizes brand values and perceived authenticity instantly.
              </p>
            </div>
          </div>
        </div>
...
Steps for Collaborative Brilliance           </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            Today, every partnership makes a brand trustworthy. Let’s discuss the co-branded journey in four inspired phases.
          </p>
        </div>
