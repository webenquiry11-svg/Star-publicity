...
const McLedHoardingsAds = () => {
  ...
  const processSteps = [
    {
      title: "Location & Permission Mapping ",
      description:
        "Star Publicity handles all the clearances and other work with municipal bodies to secure prestigious, high-traffic LED hoarding spots",
    ...
    {
      title: "Content Creation & Calibration ",
      description:
        "We manage the design part creating vibrant video ads, animation loops, or hybrid ads tailored for LED screen aspect ratios and peak viewing angles.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Launch & Live Management ",
      description:
        "Then we finalize and activate campaigns with expert scheduling and 24/7 monitoring to ensure maximum audience reach.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Impact Assessment & Optimization ",
      description:
        "Then only one step left which is accessing detailed display parameters and audience metrics to measure campaign effectiveness and results.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/TTL marketing images/mc led hoarding/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Don’t wait more to turn municipal LED hoardings into your next brand campaign in the pulse of the city.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
           Where Motion Meets Impact
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
           Every pixel of the LED hoarding represents your brand in the bold and bright way on the digital landscape of the city.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/mc led hoarding/maximum.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Most of the LED hoardings are placed at high traffic hot spots, commercial hubs, and markets, ensuring great visibility across urban audiences. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/mc led hoarding/dynamic.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
              Ability to schedule multiple ads, live feeds, and event updates which keep your message fresh, relevant, and audience focused. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/TTL marketing images/mc led hoarding/superior.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Vibrant, high-resolution LED screens always deliver sharp images with vivid colors, making your campaign unmissable even at night.
              </p>
            </div>
          </div>
        </div>
 ...
 LED Hoarding Placement Journey          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Go through the four simple phases to understand the process from concept creation to final installation.
          </p>
        </div>
...
export default McLedHoardingsAds;