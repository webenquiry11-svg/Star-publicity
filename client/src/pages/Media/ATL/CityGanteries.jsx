  ...
  const processSteps = [
    {
      ...
      description:
        "Firstly, we identify optimal city entry and exit points, as well as main intersections of the city, to select highly visible locations for your brand.",
    ...
    },
    {
      ...
      description:
        "Then our design team develops bold, visually-appealing graphics, ensuring maximum attention from every viewpoint.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "After finalizing the design, our expert team securely installs gantries using durable materials and safety standards, ensuring flawless presentation of your brand.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Our work does not end here. Star Publicity performs ongoing checks to ensure continued vibrancy and structural integrity, with campaign analytics.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/City Gantries/background image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Upscale your brand’s market presence with city gantries, massive & double-sided structures spanning across Punjab’s bustling cities.
          </p>
          {/* <button
...
Where Every Gantry Depicts a Message
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            City Gantries are behind the transformation of city commutes with high impact and maximum recall.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/City Gantries/double sided messaging.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Star Publicity delivers your OOH campaign in the market, focusing on maximizing impressions for motorists and pedestrians at the same time.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/City Gantries/landmark level recall.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Landmark Level Recall
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Gantries are placed at highly visible city gates and intersections, allowing your brand message to embed into the local memory of the viewers.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/City Gantries/round the clock.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Enjoy constant 24/7 presence and unmatched visibility through city gantries, which deliver your message in every weather condition.
              </p>
            </div>
          </div>
        </div>
...
Gantry Launch Cycle          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
From ideas to final installation and monitoring results, let’s review the process in four simple steps.
          </p>
        </div>
