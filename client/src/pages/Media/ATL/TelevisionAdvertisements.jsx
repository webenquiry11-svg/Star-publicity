...
const TelevisionAdvertisements = () => {
  const refs = [
  ...
  const processSteps = [
    {
      title: "Broadcast Blueprinting ",
      description:
        "Partner with our marketing experts to figure out target channels, peak hours, and program genres that your audience mostly like. ",
    ...
    {
      title: "Storyboard Brilliance ",
      description:
        "Then our team of profesionals join forces to shape memorable scripts, compelling visuals, and signature soundtracks to echo with your brand.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Bookings lock your advertisement into optimal time-slots, from local news evenings to any of the special, festival-days grand premieres. ",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: " Impact Analysis Loop",
      description:
        "Then our team at Star Publicity keep track of analytics, social buzz, call data, and instant surveys to quantify your reach, reactions, and ROI in real time.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/television ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Go beyond screens with Television ads that immerse your brand in living rooms, shops, and tea stalls to shape conversations, trends, and decisions.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Television isn’t just a medium for entertainment; it’s a pulse that beats in every household.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/television ads/massive.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Massive Unmatched Reach 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Connect instantly with millions of the target audience across cities, villages, and towns, with regional and national channel broadcasters.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/television ads/emotional.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Emotional Storytelling Canvas 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                TV ads are a combo of sight, sound, and storytelling to evoke laughter, nostalgia, trust, and excitement, making your brand part of shared family experiences.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/television ads/hyper target.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Hyper-Targeted Placement 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                You can select genre, language, and time slot to attract your priority audience as TV ads can be present during serials, movies, sports, or news for best results.
              </p>
            </div>
          </div>
        </div>
...
Star Publicity always ensures that every campaign is crafted for scale, storytelling, and excellent recall in four simple phases.
          </p>
        </div>
...
export default TelevisionAdvertisements;