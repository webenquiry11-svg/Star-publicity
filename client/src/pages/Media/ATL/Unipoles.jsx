  ...
  const processSteps = [
    {
      ...
      description:
        "Firstly, we analyze the location to ensure stable, compliant ground conditions, laying the foundation for secure installation in diverse urban routes.",
      // Placeholder for a dynamic icon/SVG
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12" // Removed specific blue class to allow parent to set color
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth="1.5"
    ...
    },
    {
      ...
      description:
        "After that, high-quality Unipole parts are precisely manufactured and assembled off-site to ensure durability and timely delivery.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12" // Removed specific blue class to allow parent to set color
    ...
    },
    {
      ...
      description:
        "Then Unipole is installed and secured on-site using specialized equipment, maximizing visibility and adhering to all safety standards.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12" // Removed specific blue class to allow parent to set color
    ...
    },
    {
      ...
      description:
        "After thorough checks and on-site installation, the structure is approved and activated to deliver impactful brand presence.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12" // Removed specific blue class to allow parent to set color
    ...
    <>
      ...
      <style>{`
        ...
        .process-feature-card:hover .icon-wrapper {
            ...
            background-color: #1A2A80; /* Applied new color here */
        }
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            backgroundImage: `url("/assets/ATL marketing images/ATL marketing images/Unipole/background image.png")`, 
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            ...
            <br />
            <span
              className={`block mt-4 text-5xl md:text-7xl text-blue-400 lg:text-8xl`}
              style={{transitionDelay: "0.3s" }} // Applied new color here
            >
              SHOWCASE
            </span>
          </h1>
          ...
          >
            Tall unipoles transform urban spaces into prominent platforms that enhance your brand’s visibility everywhere..
          </p>
        </div>
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Shaping Urban Brand Stories
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Let’s create a memorable impression and make your brand an integral part of the city's environment.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative overflow-hidden">
              <img
                ...
                src="/assets/ATL marketing images/ATL marketing images/Unipole/unmatched daylight visibility.png" 
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                  Unmatched Daylight Impact
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Large-format unipoles consistently focus on your brand, remain highly visible in broad daylight, and capture the attention of thousands as they travel through North India’s busiest highways and city routes
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative overflow-hidden">
              <img
                // CORRECTED: Using direct path string for src
                src="/assets/ATL marketing images/ATL marketing images/Unipole/high traffic dominance.png" 
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                High-Traffic Dominance
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Placed at key intersections and daily commuters' corridors, our unipoles provide you with top exposure, ensuring your message stands out where urban and intercity traffic is densest.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative overflow-hidden">
              <img
                // CORRECTED: Using direct path string for src
                src="/assets/ATL marketing images/ATL marketing images/Unipole/weatherproof brand presence.png" 
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Weatherproof Brand Presence
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Unipoles are designed and known for their durability and year-round effectiveness, withstanding all weather conditions to deliver consistent visibility and uninterrupted brand communication day and night.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-[#1A2A80]">
            Tailored Solutions Journey
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            Custom solutions for your brand with flawless Unipole installations.
          </p>
        </div>
