  ...
  const processSteps = [
    {
      ...
      description:
        "The first and foremost step is to analyze citywide footfall, vehicle analysis, and regional priorities to select those petrol pumps that can attract the highest audience potential.",
    ...
    },
    {
      ...
      description:
        "With a motto to present a prime placement, we design bold, high-contrast visuals and catchy messaging whether on pump islands, floors, or in-store points of sale.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "After finalizing the design, Star Publicity’s expert team installs and tests messaging across chosen assets, ensuring clarity and durability.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "The cycle does not stop at installation. We provide regular maintenance and performance reporting, guaranteeing continuous impact throughout your booking.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Petrol Pump Ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
         Position your message for maximum visibility with petrol pump advertising that turns every fuel stop into an opportunity to spark brand recall.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Waiting Means Attention 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Unlocking unmatched exposure, turning waiting time into brand exposure time with unique petrol pump ads
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Petrol Pump Ads/Footfall capture.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Strategic Footfall Capture
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Petrol pumps are one of the high footfall areas that draw a constant flow of vehicles and walk-ins, guaranteeing high-frequency audiences throughout the day.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Petrol Pump Ads/Targeted local.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Select pumps in priority neighborhoods, city entry points, and highways to uplift your campaign and align messaging to community needs
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Petrol Pump Ads/multiple touch.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Utilize various ad placements on digital screens or any of the static media for repeated and unskippable exposure.
              </p>
            </div>
          </div>
        </div>
...
Ignition-Ready Execution Path
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
From concept to campaign analysis, seamless activation is the backbone for tangible results          </p>
        </div>
