...
const IndianRailwayTrainsStations = () => {
  const refs = [
  ...
  const processSteps = [
    {
      title: "Route & Station Scouting",
      description:
        "We firstly Identify the major stations and busiest train routes as per your target areas and beyond, analyzing audience profiles and local travel flows.",
    ...
    },
    {
      ...
      description:
        "Then our strategists and designers develop high-quality visuals, relating to Indian culture, language, and regional pride for greater impact.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "After completion of the designing task, our expert team coordinates with Indian Railways and deploys your campaign across selected formats.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Most importantly, every campaign should be analyzed well, which we do effortlessly with measurable ROI and actionable campaign tweaks.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Indian railways ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
          One of the widely used transit hubs that helps your business reach millions every week, as your brand becomes part of India’s moving lifeline.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Every Journey Starts with Your Brand
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
          Even in the daylight or under the moon, railway advertising commands attention at every city, market crossings, and major capital cities etc. across India.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Indian railways ads/multi format.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                There are countless ad formats under Indian Railways Advertising, such as platform hoardings, stairway wraps, LED screens, and static boards to full-train exteriors. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Indian railways ads/Captive audience.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
            Notably, train travelers spend their valuable time at platforms and in coaches, which is the best opportunity to deliver a high recall and emotional message. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Indian railways ads/hyperlocal.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Campaigns tailored with national language, i.e., Hindi, we can promote local visuals and seasonal branding, which creates a bond with diverse audiences
              </p>
            </div>
          </div>
        </div>
...
Track-to-Transform Journey          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
From concept to launching your campaign—creating iconic journeys for your brand in just four seamless steps.          </p>
        </div>
...
export default IndianRailwayTrainsStations;