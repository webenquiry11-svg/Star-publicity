  ...
  const processSteps = [
    {
      ...
      description:
        "First of all, we identify the most effective routes, markets, and auto fleets in North Indian cities and suburban centers for your target audience.",
    ...
    },
    {
      ...
      description:
        "After spending a portion of time on fruitful research, our designers craft bold and attention-grabbing advertisements for maximum engagement.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Then we execute quick, precise fitting of branded flex or vinyl on the selected auto rickshaws, ensuring high-quality material and long-term durability.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "We also track campaign analytics and maintain branding integrity, ensuring your campaign‘s quality throughout the signed period.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Auto Rickshaw branding ads/background image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Maximize your brand’s reach across residential colonies, bazaars’ busy roads, and high-traffic areas across the city..
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
           Where Movement Means Impact 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Your brand’s message is always visible and always forefront everywhere life happens.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Auto Rickshaw branding ads/eye level branding.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Auto Rickshaw ads are seen at close range and natural sight, making your brand unmissable and easy to remember.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Auto Rickshaw branding ads/Cost Effective power.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Achieve massive impressions at a low cost as compared to other outdoor advertising expenses, ideal for both rapid reach and extended campaigns.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Auto Rickshaw branding ads/creative customization.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Full auto rickshaw wraps make your campaign stand out with attention-grabbing color and personality customized for Punjab’s local market.
              </p>
            </div>
          </div>
        </div>
...
Our Four-Tier Process          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Star Publicity can turn your vision into a moving campaign with the auto rickshaw branding in just four simple steps          </p>
        </div>
