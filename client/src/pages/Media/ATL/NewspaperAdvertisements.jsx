...
const NewspaperAdvertisements = () => {
  ...
  const processSteps = [
    {
      title: "Media Matchmaking",
      description:
        "First of all analyze your product, audience, and geographical areas to select the optimal set of newspapers.",
    ...
    {
      title: "Creative Copycraft ",
      description:
        "Then our professional writers and designers develop compelling visuals and localized messages that capture attention.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Pressroom Placement",
      description:
        "Coordinate layouts, sizes, and positions with the editorial team to ensure prominence, front page, premium zones, or inside features.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Then we keep track of insertions, gather reader feedback, and analyze post-campaign analytics, including calls, QR codes, and coupon redemptions.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Newspaper ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Newspaper ads place your message in the hands of decision-makers, families, and business-owners who deliver local resonance and top-tier recall.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Credibility Meets Conversation
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
           In demand for multiple decades, newspaper advertising always remains a trusted media format tailored for every demographic.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Newspaper ads/statewide.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Statewide Readership Reach 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Boost leading local and national readers to connect with urban, semi-urban, and rural areas of the state in one campaign. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Newspaper ads/trust built.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Trust-Built Messaging 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
               Newspapers command deep trust because your ads inherit credibility, feel genuine, and influence thought leaders.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Newspaper ads/language.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Language Versatility Delivered 
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
               Newspapers communicate in Hindi, Punjabi, English, or any other state or local language, which directly spreads your message across the nation.
              </p>
            </div>
          </div>
        </div>
...
Press Presence Route
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
           Let’s go through the steps on how we expertly navigated for timely, total reach your print campaign in four distinctive moves.
          </p>
        </div>
...
export default NewspaperAdvertisements;