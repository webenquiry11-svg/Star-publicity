...
const CityMallAdvertisements = () => {
  ...
  const processSteps = [
    {
      title: "I. Visionary Insight",
      description:
        "Our journey begins with deep market exploration, blending local nuances with global trends to sculpt a strategic foundation for your brand's unique narrative in Ludhiana.",
    ...
    {
      title: "II. Artistic Conception",
      description:
        "Here, ideas take form. Our creative studio transforms strategy into compelling visual artistry, crafting narratives that resonate across the urban canvas, from bus wraps to interior features.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "III. Precision Realization",
      description:
        "From digital concept to physical presence. We meticulously translate designs into high-quality outdoor formats, ensuring every detail reflects your brand's essence with unparalleled clarity and impact.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "IV. Evolving Presence",
      description:
        "Our commitment extends beyond deployment. We continuously monitor and adapt, ensuring your campaign evolves with the city's pulse, maintaining its relevance and maximizing its reach.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/City mall ads/background image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Meet and engage with your best customers where they generally explore, relax, and purchase.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Shopping Meets Branding
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Let’s interact with your high-spending target audience with the now-popular outdoor media format, Mall Branding.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/City mall ads/extended time.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Branding inside the city malls attracts the audience who spend hours browsing, eating, and relaxing & maximizing the campaign’s impressions and brand recall.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/City mall ads/premium brand.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Brand’s presence in bustling city malls instantly boosts your brand’s image, with the luxury and exclusivity for strong consumer trust.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/City mall ads/seasonal event.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Uplifts your presence during festivals, sales, and mall events with targeted, time-limited activations for extra buzz and shopper engagement.
              </p>
            </div>
          </div>
        </div>
...
Route to Mall Branding          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Converting regular retail visits into brand experiences every day with bustling malls of Punjab.          </p>
        </div>
...
export default CityMallAdvertisements;