  ...
  const processSteps = [
    {
      title: "Spot Sourcing",
      description:
        "It all starts with identifying high-impact locations in priority towns, markets, and rural clusters to maximize visibility and campaign relevance.",
    ...
    },
    {
      ...
      description:
        "Collaborate with our creative team to design culturally attuned, high-recognition artwork customized for your goals and local context.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Skilled Mural Execution",
      description:
        "Our team of regional artists professionally paints your message with vibrant colors and creative technique—guaranteeing both beauty and clarity.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Lasting Impression Checks",
      description:
        "Ongoing reviews and touch-ups keep your painted campaign looking clear, with regular tracking of your campaign.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/wall painting ads/artistic.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Wall paintings immerse your brand into the daily rhythm of Punjab with hand-made paintings that remain in memory and conversation.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            A clear hand-made wall painting advertisement always amplifies your campaign, i.e., every brushstroke builds trust.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/wall painting ads/bg image.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                 Artistic Local Engagement
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Hand-painted by skilled artists, your brand integrates effortlessly with Punjab’s landscapes and market structure, resonating with authenticity.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/wall painting ads/lasting presence.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               One of the most trusted features of wall paintings is the premium paints, delivering months and even years of unmissable recall.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/wall painting ads/rural.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               This outdoor meda format is placed after planning a deep strategy because these ads only appear on bylanes, village squares, and other market places where advertising simply can’t go.
              </p>
            </div>
          </div>
        </div>
...
Paintings that turn concepts into landmarks with precision, passion, and creativity at every step of the way.          </p>
        </div>
