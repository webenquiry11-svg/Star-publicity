  ...
  const processSteps = [
    {
      ...
      description:
        "Firstly, we analyze passenger flows, demographic areas, and commercial zones in targeted airports to pick high-impact placements for your brand.",
      // Placeholder for a dynamic icon/SVG
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-[#1A2A80]"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth="1.5"
    ...
    {
      title: "Sky-High Creative",
      description:
        "The next step is to design attractive & globally-inspired visuals customized for digital, static, and other media forms to ensure instant attention in a bright, fast-paced environment. ",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-[#1A2A80]"
    ...
    },
    {
      ...
      description:
        "Coordinate with airport authorities for efficient installation, ensuring displays stay visible and engaging across all areas.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-[#1A2A80]"
    ...
    },
    {
      ...
      description:
        "Not only installation, we also give you regular checks and audience data to deliver proof of brand exposure and results, with real-time adjustment flexibility.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-[#1A2A80]"
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Let’s stay top of mind because every arrival and departure promotes your brand and portrays your message clearly at airport touchpoints.
          </p>
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-[#1A2A80]">
           Where Air Journey Begin with Your Brand 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
           At present, one of the best OOH medias to attract high-spending audience through every concourse, lounge, and gate.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-[#1A2A80] mb-4">
                 Prestigious Audience Access
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
              Airports are the place where affluent, business, and international travelers spend a lot of time which is ideal for premium targeting and lasting impressions. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-[#1A2A80] mb-4">
                Multi-Format Touchpoints
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
               Airports provide a lot of media formats like digital screens, backlit panels, standees, conveyor wraps, security trays, shuttle buses, and many more for all-around reach.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               One of the best outdoor spaces for grand launches, experiential setups, and festive or sports-themed advertisements.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            A meticulously crafted journey from concept to captivating urban
            presence.
          </p>
        </div>
      ...
      <section className="relative py-24 px-6 sm:px-12 bg-[#1A2A80] text-white text-center overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-[#1A2A80] rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-[#1A2A80] rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000"></div>
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            ...
            <span className="absolute inset-0 w-full h-full bg-[#1A2A80] opacity-20 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left z-0"></span>
          </motion.a>
        </div>
      </section>
    </>
...
export default AirportAdvertisements;