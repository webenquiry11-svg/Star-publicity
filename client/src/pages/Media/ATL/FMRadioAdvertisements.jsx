  ...
  const processSteps = [
    {
      ...
      description:
        "After doing a lot of research on analyzing frequencies that fits perfect for your message, Star Publicity craft a strategy for maximum impact and recall.",
    ...
    {
      title: "Voice & Script Creation",
      description:
        "Then sound and writing scripts are accomplished by our writers and sound engineers, who create memorable scripts, aligning every ad with your brand tone.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Broadcast Activation",
      description:
        "Then the process starts for booking airtime, coordinating with station managers, and launching audio assets.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Additionally, we perform monitoring of airplay, log spot occurrences, and also collect listener feedback to deliver continuous improvement analysis.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/FM Radio ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Ride India’s favorite frequencies and resonate beyond sight with FM radios that deliver your message into homes, cars, and hearts with unmatched frequency.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Brand Meets Frequencies
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            With FM Radio ads, your brand message echoes with every tune, every show and delivers companionship, trust, and action.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/FM Radio ads/statewide.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Statewide Sonic Reach
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Some of the widely known FM radio stations like Red FM, Big FM, My FM, and Radio Mirchi are capable of connecting your brands with millions in real time.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/FM Radio ads/hyper target.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Hyper-Targeted Slots
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Choose drive-time, prime-time, genre-specific shows, or daily capsules that directly benefit your brand and land precisely where audiences are most attentive.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/FM Radio ads/multilingual.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Even you can effortlessly craft campaigns in Punjabi, Hindi, English, or any other language to resonate with every language segment and demographic.
              </p>
            </div>
          </div>
        </div>
...
Pathway to Impact 
          ...
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            From concept to airwaves, your FM radio campaign travels through four simple steps.
          </p>
        </div>
...
export default FMRadioAdvertisements;