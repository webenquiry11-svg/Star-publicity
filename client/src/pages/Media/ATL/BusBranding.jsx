  ...
  const processSteps = [
    {
      ...
      description:
        "We analyze high-traffic bus routes and popular city hubs across North India to select the best buses and locations for your target audience.",
    ...
    },
    {
      ...
      description:
        "Our professional team of designers tailors your messages and graphics for maximum clarity of the campaign and impact at eye-level distance.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Then, our expert installers place your ads at selected bus shelters, guaranteeing perfect alignment and durability.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "The process does not end at deployment. Star Publicity monitors your campaign's health and provides regular updates for a clean presentation.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Bus branding/background image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Transform local and intercity buses, including PRTC, City Buses, and other Roadways Buses into dynamic moving billboards, providing high-impact visibility across North India.
          </p>
          {/* <button
...
Crafting Brand Experiences on Wheels 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
           Where Every Route Becomes a Branding Opportunity, that’s the power of Bus Branding.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Bus branding/extensive route reach.png" // Huge billboard in a bustling city
...
Extensive Route Reach              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Utilize the widely spread network of bus routes across North India, covering everything from city hubs to rural destinations for maximum reach. 
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Bus branding/dynamic mobile messaging.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Dynamic Mobile Messaging
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                These adaptable advertisements support theme customizations, keeping your brand's presence unique during several seasons, festivals, and events.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Bus branding/Eye level visibility.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Bus advertisements are placed at eye level, ensuring that messages are noticed by motorists, pedestrians, and riders alike.
              </p>
            </div>
          </div>
        </div>
...
Our Streamlined Process          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Experience seamless brand journeys that effectively showcase your brand on the streets of North, all in four simple steps.
          </p>
        </div>
      ...
      <section className="relative py-24 px-6 sm:px-12 bg-blue-700 text-white text-center overflow-hidden">
