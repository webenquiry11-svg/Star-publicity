  ...
  const processSteps = [
    {
      ...
      description:
        "First of all, our team analyzes Punjab’s market flows, festivals, events, and the city’s bustling markets to choose the ideal journey for your campaign.",
    ...
    },
    {
      ...
      description:
        "Then the bold wraps and side panels are designed by our creative team for van formats and local viewing angles, ensuring attention at every stop.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "On-The-Road Launch",
      description:
        "Our Experienced professionals deploy your van advertising campaign, conduct live setup, and set the journey in real-time, tracking progress and performance. ",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Continuous monitoring and feedback collection provide proof-of-performance and avenues for real-time campaign results.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Van advertising/background image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            We sculpt compelling brand narratives that transform cityscapes into
            dynamic, unforgettable statements, moving with the pulse of
            Ludhiana.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Movement Multiplies Visibility
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Every street, lane, and town is an opportunity for real-time brand interaction and customer building.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Van advertising/dynamic route.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Dynamic Route Flexibility
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Vans can follow strategic routes spanning cities, urban or rural roads, and event destinations, enabling you to adjust your campaign for maximum exposure.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Van advertising/event integration ready.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Van advertising is Ideal for product launches, roadshows, and fairs, which can easily target crowds right where they gather most.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Van advertising/immersive.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               The major benefit of this media format is that you can add custom wraps on vans with customized sound systems and interactive elements.
              </p>
            </div>
          </div>
        </div>
...
Our Roadmap to Results          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Every campaign moves from concept to the final customer seamlessly, with precision and speed          </p>
        </div>
