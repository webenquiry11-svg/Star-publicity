  ...
  const processSteps = [
    {
      ...
      description:
        "The first and most important step is analyzing city maps and transit routes to choose the most effective bus shelters in Punjab.",
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
Increase citywide visibility by prominently displaying advertisements at busy bus shelters.          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Crafting Engagement Where It Counts 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
Transforming bus shelters into unique branding venues where every space is an opportunity for creativity and visibility.          </p>
        </div>
...
Bus shelters are placed at the city’s major marketplaces, intersections, and business districts, maximizing your brand exposure to diverse audiences.              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                 Constant Audience Flow
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
Your brand not only gets reach but also attracts motorists, cyclists, and daily commuters with 24/7 visibility and continual impressions.              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Prolonged Brand Interaction
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
Daily commuters and pedestrian spend most of their time at bus shelters, providing unique opportunities for your brand to create a lasting impact.              </p>
            </div>
          </div>
        </div>
      </div>
