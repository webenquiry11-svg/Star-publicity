  ...
  const processSteps = [
    {
      title: "Area Mapping",
      description:
        "It all starts with analyzing target markets, colonies, or city areas to mark the highest-traffic poles that can fulfill your brand’s objectives",
    ...
    },
    {
      ...
      description:
        "To handle the designing part, our designers create the high-impact, location-optimized ads for maximum recall in busy street environments.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Now, the most important step is to install the OOH ads, which is accomplished by our expert installers who securely fit your branded panels.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "After the final installation, we provide regular campaign analytics, so your message always looks fresh and sharp.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Pole Kiosks Ads/background image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Time to enter the network of pole kiosks, rows of vibrant, eye-level displays that multiply your brand’s message and visibility on every major colony, road, and market.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Multiplicity Drives Familiarity 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Every pole, every route, connects you with your target customers with a moment to connect with your success.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Pole Kiosks Ads/all over street.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                All-over Street Presence
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Pole kiosks are placed near main and high-traffic roads, ensuring no one can miss your brand’s message
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Pole Kiosks Ads/brand exposure.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                This ooh media format reinforces your campaign through persistent, repetitive impact at every moment.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Pole Kiosks Ads/highly reach.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Kiosk ads can be deployed in specific urban spaces like markets or city zones to attract the audience that you want.
              </p>
            </div>
          </div>
        </div>
...
Pole Path to Presence          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Let’s understand the streamlined process execution from planning to launch.
          </p>
        </div>
...
export default KiosksAdvertisements;