...
const WallWraps = () => {
  ...
  const processSteps = [
    {
      title: "Wall Discovery",
      description:
        "We search for high-exposure walls at different target location, ensuring maximum traffic with vehicle visibility, which is also relevance to your audience.",
    ...
    {
      title: "Concept Infusion",
      description:
        "Our creative team of professionals brings your ideas to life with bespoke designs, perfectly scaled and designed for the chosen wall space.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Expert Wrapping",
      description:
        "Star Publicity only use industrial-grade materials and precision tools to deliver flawless, edge-to-edge graphics, installed by our team, even on challenging surfaces.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Ongoing Vibrancy",
      description:
        "Also, our team handle timely cleaning of your campaign with a proper reporting to maintain striking visuals until the campaign period.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Wall wraps ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Time to grab attention by converting public and private walls in Punjab’s busiest areas into huge and visually-appealing canvases that can’t go unnoticed.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
           Where Space Becomes Statement 
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Wall Wraps always conveys the maximum messaging with infinite creativity realizing you that the city is your stage.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Wall wraps ads/monumental.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Monumental Brand Presence
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                One of the giant outdoor formats which converts a blank wall into an unmissable advertisements, ensuring your brand dominates from every angle.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Wall wraps ads/community.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Community-Centric Selection
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Target vital city areas ike schools, marketplaces, flyovers, and stadiums which portrays your brand’s message into the pulse of the local community.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Wall wraps ads/everyday.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                 Everyday Interaction Points
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                As wall wraps are mainly located on major walking and traffic paths, this OOH media format guarantee routine, repeat impressions for strong recall and conversation.
              </p>
            </div>
          </div>
        </div>
...
Vision-to-Wall Workflow
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Let’s discuss how we turn ideas into attractive street legends in just four simple steps.
          </p>
        </div>
