...
const MetroTrainsStations = () => {
  ...
  const processSteps = [
    {
      title: "Route Blueprinting",
      description:
        "Partner with our team to track and map footfall patterns, key stations, and market-linked routes that offer a huge audience for your brand.",
    ...
    },
    {
      ...
      description:
        "We produce bold & immersive visuals for every format, such as interiors, exteriors, static, and LED panels, tailored for metro architectural styles and local cultures.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Citywide Activation",
      description:
        "For installation of the campaign, our well-trained team handles the process at off-peak hours, coordinates with metro authorities for compliance, and deploys it.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Dynamic Analytics Loop",
      description:
        "After installing your campaign, the last step is to analyze your investment, audience heat maps, and digital engagement tracking to get results more than expected.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/ATL marketing images/ATL marketing images/Metro ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Let’s turn every metro train and every station into a brand moment, as your campaign moves through major city entries, markets, and urban areas.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
           Where Transit Becomes Engagement
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Metro Train Advertising turns every route, every stop into a built-in audience attraction tool for your brand.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Metro ads/multi format.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Multi-Format Immersion
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Promotes static panels, digital screens, train wraps, stairs, floors, escalators, and several other medias for maximum recall.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Metro ads/high dwell.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Metro environments offer high exposure, as riders and bystanders mostly stops at platforms, someone waits for train or on gates, making every minute count.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/ATL marketing images/ATL marketing images/Metro ads/dynamic.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Dynamic & Digital Impact
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                For a dynamic experience of your campaign, we utilize LED boards, interactive displays, and real-time video content that can adjust automatically.
              </p>
            </div>
          </div>
        </div>
...
Trackwise Engagement Steps
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            Every train journey is memorable and when it links with your campaign, it provides you seamless, high-energy, and precisely mapped results.
          </p>
        </div>
...
export default MetroTrainsStations;