  ...
  const processSteps = [
    {
      ...
      description:
        "It all starts with analyzing India’s busiest NH routes, identifying popular dhaba spots where most travelers can be targeted.",
    ...
    },
    {
      ...
      description:
        "Secondly, our design team focuses on local aesthetics, regional messaging, and vibrant colors to match dhaba vibes and captivate targeted audiences.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: " Immersive Deployment",
      description:
        "Then we install creative advertisements in different OOH formats ensuring sturdy, weatherproof, and highly visible displays.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Live Momentum Monitoring",
      description:
        "Routine checks, traveler feedback, and real-time analytics are also monitored to ensure your campaign stays functional and aligned for more results.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/BTL marketing images/dhaba branding/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
          Time to capture the attention of travelers via NH Dhaba Branding, which transforms bustling highway eateries/dhabas into high-impact brand destinations.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Highway Hospitality Meets Brand
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            The major advantage of this OOH platform is that every trucker, traveler, tourist, and even families will see your campaign, resulting in the desired recall rate.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/dhaba branding/traveler.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Traveler Hotspot Impact
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                NH Dhabas remain the first choice for locals, truckers, and vacationing families during travel, where they all intersect, making them perfect platforms for brand recall.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/dhaba branding/destination.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Destination-Driven Engagement
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Most of the travelers spend extended, relaxed time at National Highway Dhabas which is perfect for deeper brand exposure.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/dhaba branding/highway.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Highway-to-Heart Approach
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
             Dhaba branding in combination with regional themes and language always build instant trust in the audience and connect with the spirit of road travel.
              </p>
            </div>
          </div>
        </div>
...
Pathway to Highway Impact
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Let’s go through some of the touchpoints that make your campaign mapped for maximum road mileage.
          </p>
        </div>
