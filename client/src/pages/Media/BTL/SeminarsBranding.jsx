...
const SeminarsBranding = () => {
  ...
  const processSteps = [
    {
      title: "Target Event Mapping ",
      description:
        "We start the process with selecting the right seminars like business conclaves, academic forums, skill workshops, etc., for your audience and objectives.",
    ...
    {
      title: "Brand Integration Design ",
      description:
        "Then, stage backdrops, badges, kits, invitations,  and break zones are designed according to the event’s theme and tone.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Expert team deploys your branding like signage, handouts, branded presentation slides, and staffed interaction corners, and standees for direct engagement.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Post-Event Connection",
      description:
        "Then final step is to capture leads, feedback, and conduct follow-up emails to sustain the brand’s seminar memory.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/BTL marketing images/Seminar Branding/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Seminar Branding ensures your brand message inspires and connects with an audience ready for growth.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Learning Meets Impressions
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Let your brand lead the conversation with thoughtful audiences and their focused minds
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Seminar Branding/targeted.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Targeted Mindshare Access
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Mostly seminars gather business heads, professionals, and students seeking solutions, which is one of the unmatched categories relevant for your brand’s promotion.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Seminar Branding/multispot.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Multi-Spot Visibility
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
             This strategy can immerse your identity at every touchpoint with the help of podium banners, agenda booklets, counters, and projection screens.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Seminar Branding/knowledge.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Knowledge-Time Engagement
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
              Seminar branding provides multiple modes to promote your brand during registration, keynotes, and networking, and provides multiple visibility opportunities.
              </p>
            </div>
          </div>
        </div>
...
Thoughtflow Execution Path          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
           Time to begin your seminar branding journey, discussed below in four insightful steps.
          </p>
        </div>
...
export default SeminarsBranding;