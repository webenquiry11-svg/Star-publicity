  ...
  const processSteps = [
    {
      ...
      description:
        "Identify high traffic choke areas, festival routes, and any other city event edges for high-visibility barricade placement customized for your brand goals.",
    ...
    {
      title: " Rapid Creative Build",
      description:
        "Designing part begins with bold, easily memorable messages for drive-by and standstill moments for maximum recall.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Then Star Publicity installs barricade wraps and panels overnight or flexibly, using durable materials for visually appealing outdoor presence.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Active Pulse Monitoring",
      description:
        "We also check campaign effectiveness with continuous checks and repositioning reports to ensure full brand value and visibility.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/BTL marketing images/Traffic Barricades/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           Let’s imagine transforming busy intersections, city crossings, and market routes into interactive brand corridors.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Wait Time Turns to Brand Time
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
           Now, every barricade, every jam can be your next campaign opportunity where movement pauses and minds are aware.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Traffic Barricades/lockin.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Barricades are always placed at eye-level on city streets and crossings, to capture drivers and padestrains to focus during stop-and-go moments.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Traffic Barricades/hyperlocal.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               For more strategic approach, you can select barriers in regional markets, dense colonies, or festival routes to control visibility in targeted locations.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Traffic Barricades/round.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Traffic Barricade always operate 24/7 delivering consistent and repeat impressions at every rush hour.
              </p>
            </div>
          </div>
        </div>
...
Steps to Barricade Branding          </h2>
...
export default TrafficBerricades;