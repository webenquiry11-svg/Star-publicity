  ...
  const processSteps = [
    {
      title: "Zone Scouting",
      description:
        "It all starts with identifying the hotspots such as malls, city squares, events, or market areas where your target audience mostly gather, spend, and engagement.",
    ...
    {
      title: "Creative Kit Design",
      description:
        "Then, we start developing eye-catching boards or digital displays and arm ambassadors with talking points and samples.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Finally, we deploy our trained team at set times and routes, merging human walking billboards with lively conversation and real-time consumer interaction.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Not only placement, we also provide you with campaign data such as impressions and engagements, and adjust strategy for continuous optimization and more ROI.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
            Recreate your brand’s advertising strategy with human billboards that can walk, mingle, and interact directly with your audience where traditional ads can’t reach.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Visibility Becomes Interaction
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Time to give a face to your advertising journey with Look Walker ads and promote your brand with a human voice.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Walking Brand Canvas
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
              Let’s travel the market and crowded areas with portable, humanized, and illuminated displays that can be seen even after dark for constant visibility.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Instant Human Engagement
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                It’s a fact that brand ambassadors interact with passersby who answer questions, distribute samples, and spark memorable exchanges in order to engage more.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               Look Walker campaigns are mostly used to target specific neighborhoods, communities, or events to ensure your message seems relevant and right.
              </p>
            </div>
          </div>
        </div>
...
Steps To Street Impact           </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            From the first street to the last smile, your brand is always in motion with our strategic planning and analysis.
          </p>
        </div>
