...
const CinemaAdvertising = () => {
  ...
  const processSteps = [
    {
      title: "Theatre Selection",
      description:
        "Map out thetre and screens for greater impact or multiplexes for urban mileage, and a crowded market location for your message and audience.",
    ...
    },
    {
      ...
      description:
        "The next step is to design compelling ads in video, static, and digital formats that shine in HD, surround sound, and rich color, well-optimized for cinematic view.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: " Prime-Time Placement",
      description:
        "Then we book campaigns alongside important releases, weekend movie shows, or festival slots for packed house impact and brand exposure.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Moreover, we provide you detailed analytical reporting on ad runs, audience numbers, and real-time results.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/BTL marketing images/Cinema ads/bg image.png')`, // Dark concrete texture
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-20">
          ...
          >
           With the increasing craze of watching movies in cinemas, it is one of the most loved advertising formats that delivers your message where audiences are focused.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
            Where Cinema Attention is Amplified
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Reach every seat, every show where your ad commands full attention in a premium environment in front of a high-spending audience.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Cinema ads/localised.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Localized Targeting Power
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
               We help you choose the targeted city, town, or even specific cinema locations where you can reach just the right community to fulfill your business objectives.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Cinema ads/premium.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
               Premium Recall Rates
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Just like other premium media options, Cinema ads also encourage higher recall than TV, digital, or outdoor.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/Cinema ads/versatile.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Cinema advertising allows you to select on-screen spots like video & slides and off-screen formats like lobby branding, standees, and more.
              </p>
            </div>
          </div>
        </div>
...
From Script to Screen Success
          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
            Let’s explore the steps to to make your brand memorable which watching movies and grab more visibility and attention.
          </p>
        </div>
