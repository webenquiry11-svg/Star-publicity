...
const RetailBranding = () => {
  ...
  const processSteps = [
    {
      title: "Retail Hotspot Mapping",
      description:
        "We identify premium, high-traffic stores and marketplaces across the busy markets in North India or your selected location to target the exact shoppers you want.",
    ...
    {
      title: "Brandspace Design",
      description:
        "Then, Star Publicity develops bold layouts and designs itself for custom window displays, demo counters, and language-appropriate messaging.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    {
      title: "Onsite Rollout ",
      description:
        "Expert field team executes the production process, then installation, transforming outlets overnight into an immersive brand message.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    },
    {
      ...
      description:
        "Don’t worry about the results because we also track engagement rates and POSM impact on your brand after collecting feedback and visual analytical reports.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-12 w-12 text-blue-400"
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/BTL marketing images/retail branding/bg image.png')`, // Dark concrete texture
...
Storefront 
          ...
          >
           Branding that transforms ordinary outlets into branded experiences to build loyalty and convert casual browsers into customers across North India’s dynamic markets.
          </p>
          {/* <button
      ...
      >
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight text-gray-900">
           Where Shopping Transforms Into Storytelling
          </h2>
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
           Its trend is not going to over in the coming decade because your campaign lives at the point of decision, where purchase becomes preference.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/retail branding/immersive instore.png" // Huge billboard in a bustling city
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                Immersive In-Store Environments
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
               Retail branding covers floor graphics to murals and illuminated signage, which create a memorable experience that pulls shoppers into your brand world.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/retail branding/local market.png" // Digital advertising screen with abstract content
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
               This outdoor media strategy allows customisation of every branding element from language to offers and events.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch bg-white rounded-3xl shadow-xl overflow-hidden group">
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-[400px] overflow-hidden">
              <img
                src="/assets/BTL marketing images/retail branding/posm.png" // Top-down view of complex road network
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-left">
              <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">
                POSM Mastery Deployed
              </h3>
              <p className="text-gray-700 text-lg leading-relaxed">
                Point of Sale Materials such as shelf strips, standees, and wobblers are tailored for maximum recall rate, repeated across busy retail hubs.
              </p>
            </div>
          </div>
        </div>
...
Brandspace Deployment Route          </h2>
          <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
Let’ discuss the campaign process and results in four simple phases.
          </p>
        </div>
