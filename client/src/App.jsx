...
// --- HOMEPAGE COMPONENTS (Loaded normally for fast initial paint) ---
...
// --- HOMEPAGE COMPONENT WITH SEO & SCHEMA ---
const HomePage = () => {
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Star Publicity India",
    "image": "https://www.starpublicity.co.in/logo.png",
    "@id": "https://www.starpublicity.co.in/",
    "url": "https://www.starpublicity.co.in/",
    "telephone": "+91-7403434-074",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "SCO 136-137, 1st Floor, Feroze Gandhi Market,",
      "addressLocality": "Ludhiana",
      "postalCode": "141001",
      "addressRegion": "PB",
      "addressCountry": "IN"
    },
    "description": "The Best Outdoor Advertising Agency in North India, specializing in bus ads, strategic outdoor media, and corporate branding solutions."
  };

  return (
    <>
      <Helmet>
        <title>Outdoor Advertising Experts | Star Publicity India</title>
        <meta name="description" content="Star Publicity, the Best Outdoor Advertising Agency in North India, offers expert bus ads, strategic outdoor media & corporate branding solutions." />
        <link rel="canonical" href="https://www.starpublicity.co.in/" />
